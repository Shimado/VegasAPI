...
public class ChipsPurchaseEvent extends Event {
    ...
    public ChipsPurchaseEvent(@NotNull Player player, double chipsPrice, double chipsPriceWithTax, int chipsAmount) {
        this.player = player;
